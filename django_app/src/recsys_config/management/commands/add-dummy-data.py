...
# See the actual command class in the bottom
...
class Command(BaseCommand):
    help = 'Adds dummy data for testing purposes'
    ...
    def handle(self, *args, **options):
        ...
        article_ids = []
        for _ in range(40):
            article_ids.append(my_faker.pyint(
                min_value=9500000, max_value=9576903))
